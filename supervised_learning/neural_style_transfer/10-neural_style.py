...
class NST:
    ...
    def __init__(self, style_image, content_image,
        ...
        Args:
            ...
            var (int or float): weight for variational cost
        ...
        Raises:
            ...
            TypeError: if var is not a non-negative number
        """
    ...
    def content_cost(self, content_output):
        ...
        Args:
            content_output: tf.Tensor containing generated content output
    ...
    def generate_image(self, iterations=1000, step=None, lr=0.01,
        ...
        Args:
            ...
            step: interval at which to print costs
            lr: learning rate
        ...
        for i in range(iterations + 1):
            ...
            if best_cost is None or j_total < best_cost:
                best_cost = j_total
