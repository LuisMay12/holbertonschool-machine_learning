...
class Yolo:
    ...
    def show_boxes(self, image, boxes, box_classes, box_scores, file_name):
        """
        Displays image with bounding boxes, class names, and box scores.

        params:
        - image: a numpy.ndarray containing an unprocessed image
        - boxes: a numpy.ndarray of shape (?, 4) containing the predicted
        - box_classes: a numpy.ndarray of shape (?,) containing the cls number
        - box_scores: a numpy.ndarray of shape (?) containing the box scores
        - file_name: a string containing the original filename of the image
        """
        # Zip through the boxes, their classes and their scores
