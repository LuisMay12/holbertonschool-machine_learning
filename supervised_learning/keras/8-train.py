...
optionally validating, using early stopping, using learning rate decay
(inverse time decay, stepwise per epoch), and saving the best model
...
def train_model(network, data, labels, batch_size, epochs,
    ...
    Args:
        ...
        alpha (float): Initial learning rate for decay.
        decay_rate (float): Decay rate for inverse time decay.
        save_best (bool): Whether to save best model (lowest val_loss).
    ...
    # Save best model only if requested AND validation data exists
