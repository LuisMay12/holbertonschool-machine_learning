...
Includes Node, Leaf, and Decision_Tree classes with utilities
to compute depth, count nodes, print the tree, and retrieve leaves.
"""
...
class Node:
    ...
    def get_leaves_below(self):
        ...
        Returns:
            list: List of Leaf instances below this node.
        """
        return (
...
class Decision_Tree:
    ...
    def get_leaves(self):
        """
        Retrieve all leaves of the decision tree.

        Returns:
            list: List of Leaf instances in the tree.
        """
