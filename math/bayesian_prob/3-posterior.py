#!/usr/bin/env python3
"""Module that calculates posterior probabilities for Bayesian probability"""
import numpy as np
...
def posterior(x, n, P, Pr):
    ...
    probabilities given the observed data.
    ...
    Raises:
        ...
        ValueError: if x is not an integer that is greater than or equal to 0
